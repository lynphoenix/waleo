...
class TestBaseTypes:
    ...
    def test_feature_type_enum(self):
        """测试特征类型枚举"""
        from waleo.config.base import FeatureType
    ...
    def test_normalization_mode_enum(self):
        """测试归一化模式枚举"""
        from waleo.config.base import NormalizationMode
    ...
    def test_policy_feature(self):
        """测试策略特征定义"""
        from waleo.config.base import PolicyFeature, FeatureType
...
class TestDatasetConfig:
    ...
    def test_default_config(self):
        """测试默认配置"""
        from waleo.config.dataset import DatasetConfig
...
class TestTrainingConfig:
    ...
    def test_default_config(self):
        """测试默认配置"""
        from waleo.config.training import TrainingConfig
    ...
    def test_optimizer_config(self):
        """测试优化器配置"""
        from waleo.config.training import OptimizerConfig
    ...
    def test_scheduler_config(self):
        """测试调度器配置"""
        from waleo.config.training import SchedulerConfig
    ...
    def test_checkpoint_config(self):
        """测试检查点配置"""
        from waleo.config.training import CheckpointConfig
    ...
    def test_nested_config_access(self):
        """测试嵌套配置访问"""
        from waleo.config.training import TrainingConfig, OptimizerConfig
...
class TestEvalConfig:
    ...
    def test_default_config(self):
        """测试默认配置"""
        from waleo.config.eval import EvalConfig
...
class TestParser:
    ...
    def test_parse_arg(self):
        """测试解析单个参数"""
        from waleo.config.parser import parse_arg
    ...
    def test_parse_arg_value(self):
        """测试解析参数值"""
        from waleo.config.parser import parse_arg_value
    ...
    def test_parse_config(self):
        """测试解析配置"""
        from waleo.config.parser import parse_config
        from waleo.config.training import TrainingConfig
    ...
    def test_get_nested_attr(self):
        """测试获取嵌套属性"""
        from waleo.config.parser import get_nested_attr
        from waleo.config.training import TrainingConfig, OptimizerConfig
    ...
    def test_set_nested_attr(self):
        """测试设置嵌套属性"""
        from waleo.config.parser import set_nested_attr
        from waleo.config.training import TrainingConfig
...
class TestValidation:
    ...
    def test_validate_config(self):
        """测试验证配置"""
        from waleo.config.validation import validate_config, get_validation_errors
        from waleo.config.training import TrainingConfig
    ...
    def test_check_config_consistency(self):
        """测试检查配置一致性"""
        from waleo.config.validation import check_config_consistency
        from waleo.config.training import TrainingConfig
        from waleo.config.eval import EvalConfig
    ...
    def test_validate_all(self):
        """测试验证所有配置"""
        from waleo.config.validation import validate_all
        from waleo.config.training import TrainingConfig
        from waleo.config.eval import EvalConfig
...
class TestPlugin:
    ...
    def test_register_config(self):
        """测试注册配置"""
        from waleo.config.parser import register_config, list_plugins, get_registered_configs
    ...
    def test_unregister_config(self):
        """测试注销配置"""
        from waleo.config.parser import register_config, unregister_config, list_plugins
