...
def apply_rj2506_config():
    ...
    try:
        ...
        # 4. 修改reset方法，确保夹爪完全张开（暂时禁用，严重影响SPS！）
        # custom_reset在512并行环境中每次reset都调用set_qpos，导致SPS从1100降到43
        ...
        print(f"  - 注意: custom_reset已禁用（避免set_qpos导致SPS下降）")
